...
def distance(city1, city2):
    ...
    def mul(x):
        return x*x
    d=sqrt(mul(get_lat(city1)-get_lat(city2))+mul(get_lon(city1)-get_lon(city2)))
    return d
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    default_city=make_city('Default',lat,lon)
    if distance(default_city,city1) < distance(default_city,city2):
        return get_name(city1)
    elif distance(default_city,city1) > distance(default_city,city2):
